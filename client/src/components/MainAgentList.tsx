    ...
    const agents: Agent[] = [
      {
        ...
        content: 'Handles customer inquiries and it support for the clients',
...
const overviewData = [
  ...
  return (
    ...
    {viewMode === 'list' ? (
      /* Table View */
    <ListAgentView agents={sortedAgents} selectedAgents={selectedAgents} handleSelectAll={handleSelectAll} handleSelectAgent={handleSelectAgent} />
    ) : (
    <GridAgentView agents={sortedAgents} selectedAgents={selectedAgents} handleSelectAll={handleSelectAll} handleSelectAgent={handleSelectAgent} overviewData={overviewData} />
      /* Grid View */
