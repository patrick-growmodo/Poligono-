...
export default function GridAgentView( { agents, selectedAgents, handleSelectAll, handleSelectAgent, overviewData, onDeleteClick  }: { agents: any[], selectedAgents: any[], handleSelectAll: any, handleSelectAgent: any, overviewData: any[], onDeleteClick: (agentId: number, agentName: string) => void } ) { 
    return (
                 ...
                 <div className="flex items-start justify-between mb-[17px]">
                   ...
                   <div className="flex items-center gap-2">
                     <button 
                       ...
                       className="p-1 rounded text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-800 transition-colors"
                       title="Delete agent"
                     >
                     ...
                     <span className="text-sm text-gray-500 dark:text-gray-400">
                       <Image src="/images/icons/three-dots-dark.svg" alt="menu" width={20} height={20} className="dark:hidden" />
                       <Image src="/images/icons/three-dots.svg" alt="menu" width={20} height={20} className="hidden dark:block" />
                     </span>
                   </div>
                 </div>
