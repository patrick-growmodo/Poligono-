           ...
           {featuresData.map((feature, index) => (
             <div 
               ...
               className={`p-[64px] px-[32px] ${
                 index === 0 ? 'lg:border-r-[1px] lg:border-b-[0px] border-[#484848] md:border-r-[0px] border-b-[1px] md:border-b-[1px] ' : 
                 index === featuresData.length - 1 ? 'lg:border-b-[0px] lg:border-t-[0px] lg:border-l-[1px] border-[#484848] border-r-[0px] md:border-b-[0px] md:border-t-[1px] ' : 
                 ''
               }`}
             >
               <CardTextImage
