...
export default function ToolsNode({ data, selected }: ToolsNodeProps) {
  ...
  const contextMenuItems = [
    {
      ...
      onClick: () => {
        console.log('Edit button clicked in ToolsNode');
        if (data.onConfig) {
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <g clip-path="url(#clip0_20476_14758)">
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M5.45358 11.7296L3.31641 7.21506L5.45358 4.63867L11.999 9.54775L18.5445 4.63867V11.7296L11.999 16.6387L5.45358 11.7296Z" fill="#FF4131"/>
  ...
  <defs>
    <clipPath id="clip0_20476_14758">
      ...
      case 'notion':
        return (
<svg xmlns="http://www.w3.org/2000/svg" height="24     " viewBox="13.38 3.2 485.44 505.7" width="24">
